                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="testimonial">
                                        <p style="color: white">Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit. Nam eu sem
                                            tempor, varius quam at, luctus dui. Mauris magna metus, dapibus nec
                                            turpis vel, semper malesuada ante.</p>
                                    </div>
                                    <div class="media">
                                        <img src="../../assets/images/team1.jpg" class="mr-3" alt="">
                                ...
                                <div class="col-sm-6">
                                    <div class="testimonial">
                                        <p style="color: white">Vestibulum quis quam ut magna consequat faucibu.
                                            Eget mi suscipit
                                            tincidunt. Utmtc tempus dictum. Pellentesque virra. Quis quam ut magna
                                            consequat faucibus quam.</p>
                                    </div>
                                    <div class="media">
                                        <img src="../../assets/images/team2.jpg" class="mr-3" alt="">
                                        <div class="media-body">
                                            <div class="overview">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="media">
                                        <img src="../../assets/images/team4.jpg" class="mr-3" alt="">
                                        <div class="media-body">
                                            <div class="overview">
